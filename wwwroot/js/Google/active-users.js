    ...
    40: function (t, e) {
        gapi.analytics.ready(function () {
            gapi.analytics.createComponent("ActiveUsers", {
                ...
                execute: function () {
                    this.polling_ && this.stop(), this.render_(),   this.pollActiveUsers_();
                },
                stop: function () {
                ...
                pollActiveUsers_: function () {
                    ...
                    (this.polling_ = !0),
                        gapi.client.analytics.data.realtime.get({ ids: t.ids, metrics: "rt:activeUsers" }).then(
                            function (t) {
                                alert(t);
                                var i = t.result,
                                    n = i.totalResults ? +i.rows[0][0] : 0,
                                    s = this.activeUsers;
                                this.emit("success", { activeUsers: this.activeUsers }), n != s && ((this.activeUsers = n), this.onChange_(n - s)), 1 == this.polling_ && (this.timeout_ = setTimeout(this.pollActiveUsers_.bind(this), e));
                            }.bind(this)
                        );
                },
                onChange_: function (t) {
                    ...
                    e && (e.innerHTML = this.activeUsers),
                        ...
                        t > 0 ? this.emit("increase", { activeUsers: this.activeUsers, delta: t }) : this.emit("decrease", { activeUsers: this.activeUsers, delta: t });
                },
